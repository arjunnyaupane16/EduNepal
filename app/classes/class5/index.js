...
export default function Class5() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <TopNavBar title="Class 5" showMenu={true} showNotifications={true} />
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.grid}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class5/textbook')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class5/guidebooks')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class5/previouspapers')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class5/practicequestions')}
          >
