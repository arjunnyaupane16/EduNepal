...
export default function Class9() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <TopNavBar title="Class 9" showMenu={true} showNotifications={true} />
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.grid}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class9/textbook')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class9/guidebooks')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class9/previouspapers')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class9/practicequestions')}
          >
