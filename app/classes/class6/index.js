...
export default function Class6() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <TopNavBar title="Class 6" showMenu={true} showNotifications={true} />
      ...
      >
        ...
        <View style={styles.grid}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class6/textbook')}
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class6/guidebooks')}
            accessibilityRole="button"
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class6/previouspapers')}
            accessibilityRole="button"
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class6/practicequestions')}
            accessibilityRole="button"
