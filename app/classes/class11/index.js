...
export default function Class11() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <TopNavBar title="Class 11" showMenu={true} showNotifications={true} />
      ...
      >
        ...
        <View style={styles.grid}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class11/textbook')}
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class11/guidebooks')}
            accessibilityRole="button"
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class11/previouspapers')}
            accessibilityRole="button"
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class11/practicequestions')}
            accessibilityRole="button"
