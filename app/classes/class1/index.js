...
export default function Class1() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <TopNavBar title="Class 1" showMenu={true} showNotifications={true} />
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.grid}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class1/textbook')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class1/guidebooks')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class1/previouspapers')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class1/practicequestions')}
          >
