...
export default function Class3() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <TopNavBar title="Class 3" showMenu={true} showNotifications={true} />
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.grid}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/classes/class3/textbook')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class3/guidebooks')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class3/previouspapers')}
          >
          ...
          <TouchableOpacity
            style={[styles.card, { backgroundColor: theme.cardBackground, borderColor: theme.border }]}
            onPress={() => router.push('/classes/class3/practicequestions')}
          >
